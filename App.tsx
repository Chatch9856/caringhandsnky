      ...
      <ToastProvider>
        <Layout>
          <Routes>
            ...
            <Route path={ROUTE_BOOKING_PUBLIC} element={<PublicBookingPage />} /> {/* New public booking page */}
            <Route path={ROUTE_BOOK_CARE} element={<BookCarePage />} /> {/* Old page, still accessible */}
